module github.com/middleware-labs/opentelemetry-go-extra/otelgraphql/example

go 1.18

replace github.com/middleware-labs/opentelemetry-go-extra/otelgraphql => ../
...
require (
	...
	github.com/middleware-labs/opentelemetry-go-extra/otelgraphql v0.1.21
