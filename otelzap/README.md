[![PkgGoDev](https://pkg.go.dev/badge/github.com/middleware-labs/opentelemetry-go-extra/otelzap)](https://pkg.go.dev/github.com/middleware-labs/opentelemetry-go-extra/otelzap)
...
```shell
go get github.com/middleware-labs/opentelemetry-go-extra/otelzap
```
...
import (
    "go.uber.org/zap"
    "github.com/middleware-labs/opentelemetry-go-extra/otelzap"
)
...
[otelzap.New](https://pkg.go.dev/github.com/middleware-labs/opentelemetry-go-extra/otelzap#New) accepts a
couple of [options](https://pkg.go.dev/github.com/middleware-labs/opentelemetry-go-extra/otelzap#Option):
